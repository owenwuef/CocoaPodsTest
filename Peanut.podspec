...
Pod::Spec.new do |s|
  ...
  s.author             = { "owenWU" => "wuwen128@gmail.com" }
  # s.authors          = { "owenWU" => "wuwen128@gmail.com", "other author" => "email@address.com" }
  # s.author           = 'owenWU', 'other author'
  # s.social_media_url = "http://twitter.com/owenWU"
